...
% 
function overlap = spotsize_scalefactor(a0px,a0py,mode, m, n)
if ( nargin < 3 )
    error('Usage: overlap = spotsize_scalefactor(a0px,a0py,mode,m=0,n=0)');
end
if ( nargin < 4 )
    m = 0; n = 0;
end
...
%Xpts = 513; 1024; Ypts = Xpts; x = linspace(-0.8e-3, +0.8e-3,Xpts); y = x;
